-----------------------------------------------------------------------
-- NeoVim config module for plaing with your pets
-----------------------------------------------------------------------
...
local M = {
	...
	config = function()
		require("pets").setup({
			...
			death_animation = false, -- animate the pet's death, set to false to feel less guilt -- currently no animations are available
